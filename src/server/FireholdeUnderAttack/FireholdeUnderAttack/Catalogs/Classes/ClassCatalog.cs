        ...
        new Dictionary<string, ClassDefinition>
        {
            ["protector"] = new(
                ...
                Level3Feature: new(
                    ...
                    {
                        var player = state.Players.First(p => p.PlayerId == playerId);
                        player.AvailableActions.Add("protect");
                    }),
                Level4Feature: new(
                    "Nuh Uh!",
                    ...
                    {
                        var player = state.Players.First(p => p.PlayerId == playerId);
                        player.AvailableActions.Add("invincible");
                    })
            ),
            ...
            ["elementalist"] = new(
                ...
                Level2Feature: new(
                    ...
                    (state, _) => SpawnElementalSoul(state)),
                Level3Feature: new(
                    "Double Trouble",
                ...
                Level4Feature: new(
                    ...
                    {
                        var player = state.Players.First(p => p.PlayerId == playerId);
                        player.AvailableActions.Add("cataclysm");
                    })
            ),
            ...
            ["healer"] = new(
                ...
                Level2Feature: new(
                    ...
                    {
                        var player = state.Players.First(p => p.PlayerId == playerId);
                        player.AvailableActions.Add("heal");
                    }),
                Level3Feature: new(
                    "Revive",
                    ...
                    {
                        var player = state.Players.First(p => p.PlayerId == playerId);
                        player.AvailableActions.Add("revive");
                    }),
                Level4Feature: new(
                    ...
                    {
                        var player = state.Players.First(p => p.PlayerId == playerId);
                        player.AvailableActions.Add("desperate_prayer");
                    })
            ),
        };

    public static void SpawnElementalSoul(GameEngine.GameState state)
    {
        var occupiedTiles = state.Players.Select(p => p.CurrentTile).ToHashSet();
        var target = state.Board.Tiles
            .Where(t => !occupiedTiles.Contains(t.Id) && !t.Effects.Contains(TileEffects.ElementalSoul))
            .OrderBy(_ => Random.Shared.Next())
            .FirstOrDefault();
        target?.Effects.Add(TileEffects.ElementalSoul);
    }
}
